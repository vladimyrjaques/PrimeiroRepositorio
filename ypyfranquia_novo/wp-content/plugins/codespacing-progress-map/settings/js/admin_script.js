...
jQuery(document).ready(function($){ 
	...
	$('label[id=codespacingprogressmap_layoutsettings_main_layout_mu-cd]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/mu-cd.png" />'
	});		
	
	$('label[id=codespacingprogressmap_layoutsettings_main_layout_md-cu]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/md-cu.png" />'
	});		
	
	$('label[id=codespacingprogressmap_layoutsettings_main_layout_mr-cl]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/mr-cl.png" />'
	});		
	
	$('label[id=codespacingprogressmap_layoutsettings_main_layout_ml-cr]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/ml-cr.png" />'
	});		
	
	$('label[id=codespacingprogressmap_layoutsettings_main_layout_m-con], label[id=codespacingprogressmap_layoutsettings_main_layout_fit-in-map-top-carousel], label[id=codespacingprogressmap_layoutsettings_main_layout_fullscreen-map-top-carousel]').qtip({
	  style: 'mystyle',
	...
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_square_bubble]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/square_bubble.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_rounded_bubble]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/rounded_bubble.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_cspm_type1]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/infobox_1.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_cspm_type2]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/infobox_2.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_cspm_type3]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'settings/img/tooltips/infobox_3.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_cspm_type4]').qtip({
	  style: 'mystyle',
	...
	$("#cspm_form").validate({
		...
		rules: {
			...
			"codespacingprogressmap_settings[codespacingprogressmap_layoutsettings_layout_fixed_width]":{
				number: true
			},						
			"codespacingprogressmap_settings[codespacingprogressmap_layoutsettings_layout_fixed_height]":{
				required: true,
				number: true
			},
	...
	// Regenerate Markers
	$('a#codespacingprogressmap_troubleshooting_regenerate_markers_link').livequery('click', function(){
		...
		if (result == true) {
			...
			jQuery.post(
				...
				{
					action: 'cspm_create_markers_array_for_latest_version',
				},
				function(data){	
